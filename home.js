...
const information = {
  en: {
    ...
    bigPhotoText2: 'Palisade 2026, the latest extension of Hyundai`s luxury family SUV lineup',
    ...
    pictureParagraph2: 'Rolls-Royce announced a new release of its luxurious electric car, the Spectre.',
  ...
  وتدعم نظام تبديل البطاريات السريع عبر شبكة Nio لتغيير البطاريات.`,
    ...
    bigPhotoText2: 'باليسيد 2026 الامتداد الأحدث لسلسلة سيارات الدفع الرباعي العائلية الفاخرة من هيونداي',
    ...
    pictureParagraph2: 'أعلنت شركة رولز رويس عن إصدار جديد من سياراتها الكهربائية الفاخرة، سبيكتر.',

    pictureText3: 'BMW ترفض التراجع',
    pictureParagraph3: 'تستعد شركة بي أم دبليو لإحداث تغيير جذري في عالم السيارات الكهربائية من خلال سيارتها الجديدة',
