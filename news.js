...
let dinamic_news = document.querySelector(".dinamic_news");
let filter = document.querySelector(".filter");
let all2 = document.querySelectorAll(".all2");

let elemet = [dinamic_news, filter, ...all2];

function showElement(element) {
  window.addEventListener("scroll", () => {
    let elementPosition = element.getBoundingClientRect();
    if (
      elementPosition.top < window.innerHeight - 200 &&
...
elemet.forEach((el) => showElement(el));
